...
//   infinite: false,
//   speed: 500,
//   slidesToShow: 1, // Display one set of articles at a time
//   slidesToScroll: 1,
//   centerMode: false, // Do not use center mode
// };
...
//       ? newsData.data
//       : newsData.data.filter(item => item.category === selectedCategory);
...
//       {/* Articles Carousel */}
//       <Slider {...sliderSettings} className={styles.articleCarousel}>
//         <div>
...
//                   <button
//                     onClick={e =>
//                       handleClick(e, item.id, item.title, item.imageUrl)
//                     }
  ...
  const sliderSettings = {
    customPaging: function (i) {
      return (
        <button
          className={`${styles.categoryButton} ${
            categories[i] === selectedCategory ? styles.active : ''
          }`}
    ...
    beforeChange: (oldIndex, newIndex) =>
      setSelectedCategory(categories[newIndex]), // 카테고리 상태 변경
  };
